...
public class bookList extends javax.swing.JFrame {
    ...
    ResultSet prs;
    public bookList(ResultSet rs) {
        prs=rs;
        initComponents();
        try{
            DefaultTableModel tb =(DefaultTableModel) tbl.getModel();
            dbAdmin ob =new dbAdmin();
            String sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id";
            rs = ob.getResultSet(sql, "book");
            eraseList(tb);
            showList(rs,tb);
            tb =(DefaultTableModel) tbl2.getModel();
...
//            rs.previous();
            ...
            do{
                System.out.println(rs.getString("id"));
                String arr[] = {rs.getString("id"), rs.getString("name"), rs.getString("count"), rs.getString("y.name"), rs.getString("x.au_id")};
    ...
    public void showList2(ResultSet rs,DefaultTableModel ob) {
        try {
//            rs.previous();
            System.out.println("rnter in show");
            System.out.println(rs.getString("id"));
...
//        table1.getRowCount();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("*PLEASE CHOSE FROM AUTHORS");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(t3, javax.swing.GroupLayout.DEFAULT_SIZE, 92, Short.MAX_VALUE)
                                            .addComponent(t4))
                                        .addGap(18, 18, 18)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql="SELECT * FROM author where name like '%"+t1.getText()+"%'";
            dbAdmin ob =new dbAdmin();
            ResultSet rs = ob.getResultSet(sql, "dont depend");
            eraseList(tb);
            showList2(rs,tb);
        }catch(Exception e){
            System.out.println(e);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            DefaultTableModel tb =(DefaultTableModel) tbl.getModel();
            String sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id WHERE x.name like '%"+t2.getText()+"%'";
            dbAdmin ob =new dbAdmin();
            ResultSet rs = ob.getResultSet(sql, "book");
            eraseList(tb);
            showList(rs,tb);
        }catch(Exception e){
            System.out.println(e);
    ...
    private void tbl2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl2MouseClicked
        ...
        try{
            DefaultTableModel tb =(DefaultTableModel) tbl.getModel();
            String sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id WHERE y.name like '%"+tbl2.getValueAt(tbl2.getSelectedRow(), 1).toString()+"%'";
            dbAdmin ob =new dbAdmin();
            ResultSet rs = ob.getResultSet(sql, "book");
            eraseList(tb);
            showList(rs,tb);
            l1.setText("#####");
            l2.setText(tbl2.getValueAt(tbl2.getSelectedRow(), 0).toString());
            t3.setText("");
            t4.setText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        try{
            String sql="UPDATE book SET `name` = '"+t3.getText()+"', `count` = '"+t4.getText()+"', `au_id` = '"+l2.getText()+"' WHERE (`id` = '"+l1.getText()+"')";
            dbAdmin ob=new dbAdmin();
            ob.updateData(sql);
            DefaultTableModel tb = (DefaultTableModel) tbl.getModel();       
            sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id WHERE x.au_id like '%"+l2.getText()+"%'";
            ResultSet rs = ob.getResultSet(sql, "dont care");
            eraseList(tb);
            showList(rs,tb); 
        }catch(Exception e){
            System.out.println(e);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        try{
            String sql="DELETE FROM book WHERE id = '"+l1.getText()+"'";
            dbAdmin ob=new dbAdmin();
            ob.updateData(sql);
            DefaultTableModel tb = (DefaultTableModel) tbl.getModel();       
            sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id WHERE x.au_id like '%"+l2.getText()+"%'";
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        try{
            ...
            t3.setText(tbl.getValueAt(tbl.getSelectedRow(), 1).toString());
            t4.setText(tbl.getValueAt(tbl.getSelectedRow(), 2).toString());
            l2.setText(tbl.getValueAt(tbl.getSelectedRow(), 4).toString());
        }catch(Exception e){
            System.out.println(e);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            String sql="INSERT INTO book (`id`, `name`, `count`,`au_id`) VALUES ('"+l1.getText()+"' , '"+t3.getText()+"', '"+t4.getText()+"', '"+l2.getText()+"')";
            dbAdmin ob=new dbAdmin();
            ob.updateData(sql);
            DefaultTableModel tb = (DefaultTableModel) tbl.getModel();       
            sql="SELECT x.id,x.name,x.count,y.name,x.au_id FROM book AS x INNER JOIN author AS y ON x.au_id = y.id WHERE x.au_id like '%"+l2.getText()+"%'";
